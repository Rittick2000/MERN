    ...
    <div className="w-full h-full py-10 max-w-[1200px] mx-auto px-5 lg:px-0">
      <div className="flex flex-col gap-y-3">
        <input
          ...
          className="focus:outline-none w-full bg-transparent border rounded-md p-2 shadow-[0_3px_10px_rgb(0,0,0,0.3)]"
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
        />

        <div className="flex flex-col border border-[rgba(128,121,121,0.3)] py-4 rounded-[0.4rem] shadow-[0_3px_10px_rgb(0,0,0,0.3)]">
              ...
              filteredData.map((data) => {
                return (
                  <div
                    ...
                    hover:shadow-[rgba(0,_0,_0,0.5)_0px_30px_90px] transition duration-300 shadow-[0_3px_10px_rgb(0,0,0,0.3)]"
                    key={data._id}
                  >
