...
function App() {
  ...
  const addValue=()=>{
    ...
    // because useState sends the updates in batches to UI.
    ...
    // setCounter supports a callback, so everytime we ask for prevCounter and then update the prevCounter value
